...
set_from_env($cfg, 'dbhost', 'MAHARA_DB_HOST', 'mahara-db');
...
set_from_env($cfg, 'sendemail', 'MAHARA_SEND_EMAIL', false);
...
set_from_env($cfg, 'urlsecret', 'MAHARA_URL_SECRET', null);
set_from_env($cfg, 'passwordsaltmain', 'MAHARA_PASSWORD_SALT_MAIN', 'MySpEcIaLaNdPrIvAtEsAlT');
set_from_env($cfg, 'passwordsaltalt1', 'MAHARA_PASSWORD_SALT_ALT1', 'MySpEcIaLaNdPrIvAtEsAlTaLt');
